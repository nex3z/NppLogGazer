...
{
    public class QuickSearchSettings
    {
        ...
        public class Config
        {
            public string version = QuickSearchSettings.Version;
        ...
        {
            string configFileName = Path.Combine(ConfigDir, PluginName + "QuickSearchConfig.xml");
            try
            {
